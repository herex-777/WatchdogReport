...
public class CommandManager {
    ...
    private boolean handleBan(CommandSender sender, String[] args) {
        ...
        if (punishmentManager.isPlayerBanned(playerName)) {
            plugin.sendMessage(sender, "&c" + playerName + " is already been banned!");
            return true;
        }
    ...
    private boolean handleTempBan(CommandSender sender, String[] args) {
        ...
        if (duration <= 0) {
            plugin.sendMessage(sender, "&cInvalid duration format!");
            return true;
        }
    ...
    private boolean handleMute(CommandSender sender, String[] args) {
        ...
        if (punishmentManager.isPlayerMuted(playerName)) {
            plugin.sendMessage(sender, "&c&n" + playerName + " &chas been already been muted!");
            return true;
        }
    ...
    private boolean handleKick(CommandSender sender, String[] args) {
        ...
        if (args.length < startIndex + 2) {
            plugin.sendMessage(sender, "&cUsage: /kick <player> <duration>");
            return true;
        }
        ...
        Player target = Bukkit.getPlayer(playerName);
        if (target == null) {
            plugin.sendMessage(sender, "&c&o" + playerName + " &7is not online!");
            return true;
        }
        ...
        if (punishmentManager.addPunishment(playerName, null, null,
                ...
                sender.getName(), 0, silent)) {
            plugin.sendMessage(sender, "&c&o" + playerName + " &7was successfully kicked!");
    ...
    private boolean handleUnban(CommandSender sender, String[] args) {
        ...
        if (args.length < 1) {
            plugin.sendMessage(sender, "&cUsage: /unban <player/ip>");
            return true;
        }
        ...
        if (punishmentManager.removePunishment(target, "BAN") ||
            ...
            plugin.sendMessage(sender, "&c&n" + target + " &cis not banned!");
        }
    ...
    private boolean handleUnmute(CommandSender sender, String[] args) {
        ...
        if (punishmentManager.removePunishment(target, "MUTE") ||
            ...
            plugin.sendMessage(sender, "&c&n" + target + " &7was successfully unmuted!");
            ...
            plugin.sendMessage(sender, "&c&n" + target + " is not muted!");
        }
    ...
    private boolean handleHistory(CommandSender sender, String[] args) {
        ...
        if (args.length < 1) {
            plugin.sendMessage(sender, "&cUsage: /history <player> <page>");
            return true;
        }
