...
public class ReportManager {
    ...
    public void openReportGUI(Player player, String reportedName) {
        ...
        skullMeta.setDisplayName(ChatColor.GRAY + "/report " + ChatColor.AQUA + reportedName);
        skullMeta.setLore(Arrays.asList(ChatColor.GRAY + ""));
        ...
        menu.setItem(23, createMenuItem(Material.BANNER, ChatColor.GREEN + "Bad Skin", VersionAdapter.isLegacy() ? (short) 2 : (short) 0));
        ...
        menu.setItem(30, createMenuItem(Material.MONSTER_EGG, ChatColor.GREEN + "Bad Pet name", VersionAdapter.isLegacy() ? (short) 92 : (short) 0));
    ...
    public void openConfirmationMenu(Player player, String reportedName, String reason) {
        ...
        headMeta.setDisplayName(ChatColor.GRAY + "/report " + ChatColor.AQUA + reportedName);
        headMeta.setLore(Arrays.asList(
                ChatColor.GRAY + "",
                ChatColor.YELLOW + "Report " + reportedName + " for "  + reason
        ));
